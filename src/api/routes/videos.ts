    ...
    post: {
        ...
        '/generations': async (request: Request) => {
            ...
            request
                ...
                .validate('body.wait', v => _.isUndefined(v) || (_.isBoolean(v) || (typeof v === 'string' && (v === 'true' || v === 'false'))))
                .validate('body.wait_timeout_seconds', v => _.isUndefined(v) || (_.isFinite(v) || (typeof v === 'string' && !isNaN(parseFloat(v)))))
                .validate('body.poll_interval_ms', v => _.isUndefined(v) || (_.isFinite(v) || (typeof v === 'string' && !isNaN(parseFloat(v)))));
            ...
            if (!_.isUndefined(request.body.duration)) {
                ...
                if (isMultiPart && typeof request.body.duration === 'string') {
                    const parsedDuration = parseMultipartStrictInt(request.body.duration);
                    if (_.isUndefined(parsedDuration)) {
            ...
            const finalDuration = isMultiPart
            ...
            if (typeof generatedVideoUrl !== "string") {
